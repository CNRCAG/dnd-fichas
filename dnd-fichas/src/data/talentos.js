...
export const TALENTOS = [
  ...
  { id: "duelista-defensivo", nome: "Duelista Defensivo", descricao: "Com uma arma leve em mãos, pode usar a reação pra somar seu bônus de proficiência à CA contra um ataque corpo a corpo.", preRequisito: { atributo: "destreza", valorMinimo: 13 } },
  ...
  { id: "adepto-elemental", nome: "Adepto Elemental", descricao: "Magias de um tipo de dano escolhido ignoram resistência a esse dano, e dados de dano mínimo 1 nesse tipo.", preRequisito: { conjurador: true } },
  ...
  { id: "conjurador-guerra", nome: "Conjurador de Guerra", descricao: "Vantagem em salvaguardas de Constituição pra manter concentração e pode conjurar magias com as mãos ocupadas.", preRequisito: { conjurador: true } },
];
