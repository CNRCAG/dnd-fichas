...
export const MAGIAS = [
  ...
  { id: "explosao-mistica", nome: "Explosão Mística", nivel: 0, escola: "evocacao", tempo: "1 ação", alcance: "36m", componentes: "V, S", duracao: "Instantânea", descricao: "Um feixe de energia arcana atinge uma criatura.", ataque: true, dano: "1d10 força" },
  { id: "toque-chocante", nome: "Toque Chocante", nivel: 0, escola: "evocacao", tempo: "1 ação", alcance: "Toque", componentes: "V, S", duracao: "Instantânea", descricao: "Choque elétrico dificulta a reação do alvo.", ataque: true, dano: "1d8 elétrico", condicao: "Não pode usar reações até o próximo turno" },
  { id: "resistencia", nome: "Resistência", nivel: 0, escola: "abjuracao", tempo: "1 ação", alcance: "Toque", componentes: "V, S, M", duracao: "Concentração, 1 minuto", concentracao: true, descricao: "O alvo pode somar 1d4 em uma salvaguarda antes de a magia terminar." },
  { id: "chicote-de-espinhos", nome: "Chicote de Espinhos", nivel: 0, escola: "transmutacao", tempo: "1 ação", alcance: "9m", componentes: "V, S, M", duracao: "Instantânea", descricao: "Um cipó espinhoso puxa a criatura atingida.", ataque: true, dano: "1d6 perfurante" },
  ...
  { id: "amizade-animal", nome: "Amizade Animal", nivel: 1, escola: "encantamento", tempo: "1 ação", alcance: "9m", componentes: "V, S, M", duracao: "24 horas", descricao: "Convence uma besta de que você não oferece perigo.", resistencia: "sabedoria", condicao: "Fica enfeitiçada se falhar" },
  { id: "palavra-curativa", nome: "Palavra Curativa", nivel: 1, escola: "evocacao", tempo: "1 ação bônus", alcance: "18m", componentes: "V", duracao: "Instantânea", descricao: "Uma palavra de encorajamento recupera poucos PV à distância." },
  { id: "marca-do-cacador", nome: "Marca do Caçador", nivel: 1, escola: "adivinhacao", tempo: "1 ação bônus", alcance: "27m", componentes: "V", duracao: "Concentração, 1 hora", concentracao: true, descricao: "Marca uma presa para causar dano extra e rastreá-la." },
  { id: "raio-guia", nome: "Raio Guia", nivel: 1, escola: "evocacao", tempo: "1 ação", alcance: "36m", componentes: "V, S", duracao: "1 rodada", descricao: "Luz radiante fere o alvo e facilita o próximo ataque contra ele.", ataque: true, dano: "4d6 radiante" },
  { id: "fogo-das-fadas", nome: "Fogo das Fadas", nivel: 1, escola: "evocacao", tempo: "1 ação", alcance: "18m", componentes: "V", duracao: "Concentração, 1 minuto", concentracao: true, descricao: "Contorna alvos com luz e revela invisíveis.", resistencia: "destreza" },
  ...
  { id: "arma-espiritual", nome: "Arma Espiritual", nivel: 2, escola: "evocacao", tempo: "1 ação bônus", alcance: "18m", componentes: "V, S", duracao: "1 minuto", descricao: "Cria uma arma flutuante que ataca usando seu atributo de conjuração." },
  { id: "arma-magica", nome: "Arma Mágica", nivel: 2, escola: "transmutacao", tempo: "1 ação bônus", alcance: "Toque", componentes: "V, S", duracao: "Concentração, 1 hora", concentracao: true, descricao: "Uma arma não mágica recebe +1 em ataques e dano." },
  { id: "passos-sem-rastros", nome: "Passos sem Rastros", nivel: 2, escola: "abjuracao", tempo: "1 ação", alcance: "Pessoal", componentes: "V, S, M", duracao: "Concentração, 1 hora", concentracao: true, descricao: "Concede discrição sobrenatural ao grupo e dificulta rastreá-lo." },
  { id: "silencio", nome: "Silêncio", nivel: 2, escola: "ilusao", tempo: "1 ação", alcance: "36m", componentes: "V, S", duracao: "Concentração, 10 minutos", concentracao: true, descricao: "Cria uma esfera onde nenhum som atravessa; conjuração verbal falha dentro dela." },
